...
from collective.cleanupzodb.tests import layer
from collective.cleanupzodb.tests import utils
...
class UnitTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from collective.cleanupzodb.browser.interfaces import ILayer
